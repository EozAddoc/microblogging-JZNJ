...
<head>
    ...
    <style>
        ...
        *,
        ...
        .bg-yellow {
            --tw-bg-opacity: 1;
            background-color: rgb(255 234 1 / var(--tw-bg-opacity))
        }
        ...
        .text-yellow {
            --tw-text-opacity: 1;
            background-color: rgb(255 234 1 / var(--tw-text-opacity))
        }
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-white sm:items-center py-4 sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <div>
                    <img src="meerkat.gif">
                    <span class="text-9xl text-gray-500 font-amatic font-black">Suri'</span>
                    <span class="text-9xl bg-yellow text-gray-500 font-amatic font-black">chat</span>
                    <span class="text-xl ml-2 text-gray-500 font-amatic font-black">Microblogging</span>
