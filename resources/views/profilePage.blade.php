                            ...
                            <div class="rounded-2xl shadow-xl h-fit bg-white text-gray-700">
                                <div class="w-fit rounded overflow-hidden shadow-none">
                                        ...
                                        <div class="menu-nav mr-2">
                                            <div class="dropdown-container" tabindex="-1">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <form method="POST"
                                                        action="{{route('profilePage.destroy',$post->id )}}"
                                                    ...
                                                    <a class="text-blue-400 hover:text-blue-600"
                                                        href="{{route('updatePost.updateForm',$post->id )}}"
                                                        type="submit">Modify</a>
                                    ...
                                    <div class="w-fit rounded overflow-hidden shadow-none">
                                        ...
                                        <img class="h-96 md:h-80 object-cover max-w-full min-w-full"
                                            src="{{ $post->img_url }}" alt="post">

                                        <div class="px-6 pt-4">
                                            <div>
                                                <div class="flex items-center">
                                                    <form method="post" action="{{route('dashboard.likePost')}}"
                                                        enctype="multipart/form-data" accept-charset="UTF-8">
                                                        {{ csrf_field()}}
                                                        <button type="submit"> <svg
                                                                class="heart text-gray-700 mr-1 inline-block h-7 w-7  "
